@echo off
echo ========================================
echo Relief Carving GUI - Stepwise Mode
echo ========================================
echo.
...
echo.
echo ========================================
echo Starting Stepwise Processing GUI...
echo ========================================
echo.
echo The GUI will open in your browser at:
echo http://127.0.0.1:7861
echo.
echo This is the STEPWISE interface - run each step independently!
echo For the automatic interface, use run_gui.bat instead.
echo.
echo Press Ctrl+C to stop the GUI
echo ========================================
echo.

python gradio_gui_stepwise.py
